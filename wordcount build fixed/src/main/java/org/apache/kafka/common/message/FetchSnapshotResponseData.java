...
public class FetchSnapshotResponseData implements ApiMessage {
    ...
    public FetchSnapshotResponseData(Struct _struct, short _version) {
    ...
    public void fromStruct(Struct struct, short _version) {
        ...
        this.errorCode = struct.getShort("error_code");
        {
            ...
            this.topics = new ArrayList<TopicSnapshot>(_nestedObjects.length);
            for (Object nestedObject : _nestedObjects) {
                this.topics.add(new TopicSnapshot((Struct) nestedObject, _version));
            }
        }
    ...
    public Struct toStruct(short _version) {
        ...
        struct.set("error_code", this.errorCode);
        {
            ...
            int i = 0;
            for (TopicSnapshot element : this.topics) {
    ...
    public static class TopicSnapshot implements Message {
        ...
        public TopicSnapshot(Struct _struct, short _version) {
            fromStruct(_struct, _version);
        }
        ...
        public void fromStruct(Struct struct, short _version) {
            ...
            this.name = struct.getString("name");
            {
                ...
                this.partitions = new ArrayList<PartitionSnapshot>(_nestedObjects.length);
                for (Object nestedObject : _nestedObjects) {
                    this.partitions.add(new PartitionSnapshot((Struct) nestedObject, _version));
                }
            }
            if (!_taggedFields.isEmpty()) {
                this._unknownTaggedFields = new ArrayList<>(_taggedFields.size());
        ...
        public Struct toStruct(short _version) {
            if (_version > 0) {
                throw new UnsupportedVersionException("Can't write version " + _version + " of TopicSnapshot");
            }
            TreeMap<Integer, Object> _taggedFields = null;
            _taggedFields = new TreeMap<>();
            Struct struct = new Struct(SCHEMAS[_version]);
            struct.set("name", this.name);
            {
                ...
                int i = 0;
                for (PartitionSnapshot element : this.partitions) {
                    _nestedObjects[i++] = element.toStruct(_version);
                }
    ...
    public static class PartitionSnapshot implements Message {
        ...
        public static final Schema SCHEMA_0 =
            new Schema(
                ...
                new Field("bytes", Type.COMPACT_BYTES, "Snapshot data."),
                TaggedFieldsSection.of(
        ...
        public PartitionSnapshot(Struct _struct, short _version) {
            fromStruct(_struct, _version);
        }
        ...
        public PartitionSnapshot() {
            ...
            this.size = 0L;
            this.position = 0L;
            this.bytes = ByteUtils.EMPTY_BUF;
        }
        ...
        public void read(Readable _readable, short _version) {
            ...
            this.position = _readable.readLong();
            {
                ...
                length = _readable.readUnsignedVarint() - 1;
                if (length < 0) {
                    throw new RuntimeException("non-nullable field bytes was serialized as null");
                } else {
                    this.bytes = _readable.readByteBuffer(length);
                }
            }
            this._unknownTaggedFields = null;
            int _numTaggedFields = _readable.readUnsignedVarint();
        ...
        public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
            ...
            _writable.writeUnsignedVarint(bytes.remaining() + 1);
            _writable.writeByteBuffer(bytes);
            RawTaggedFieldWriter _rawWriter = RawTaggedFieldWriter.forFields(_unknownTaggedFields);
            _numTaggedFields += _rawWriter.numFields();
            _writable.writeUnsignedVarint(_numTaggedFields);
            {
        ...
        public void fromStruct(Struct struct, short _version) {
            ...
            this._unknownTaggedFields = null;
            _taggedFields = (NavigableMap<Integer, Object>) struct.get("_tagged_fields");
            this.index = struct.getInt("index");
            this.errorCode = struct.getShort("error_code");
            this.snapshotId = new SnapshotId((Struct) struct.get("snapshot_id"), _version);
            if (_taggedFields.containsKey(0)) {
                this.currentLeader = new LeaderIdAndEpoch((Struct) _taggedFields.remove(0), _version);
            } else {
                this.currentLeader = new LeaderIdAndEpoch();
            }
            this.size = struct.getLong("size");
            this.position = struct.getLong("position");
            this.bytes = struct.getBytes("bytes");
            if (!_taggedFields.isEmpty()) {
                this._unknownTaggedFields = new ArrayList<>(_taggedFields.size());
                for (Entry<Integer, Object> entry : _taggedFields.entrySet()) {
                    this._unknownTaggedFields.add((RawTaggedField) entry.getValue());
        ...
        public Struct toStruct(short _version) {
            if (_version > 0) {
                throw new UnsupportedVersionException("Can't write version " + _version + " of PartitionSnapshot");
            }
            TreeMap<Integer, Object> _taggedFields = null;
            _taggedFields = new TreeMap<>();
            Struct struct = new Struct(SCHEMAS[_version]);
            ...
            struct.set("error_code", this.errorCode);
            struct.set("snapshot_id", this.snapshotId.toStruct(_version));
            if (!this.currentLeader.equals(new LeaderIdAndEpoch())) {
                _taggedFields.put(0, currentLeader.toStruct(_version));
            }
            struct.set("size", this.size);
            struct.set("position", this.position);
            struct.set("bytes", this.bytes);
            struct.set("_tagged_fields", _taggedFields);
            return struct;
        }
        ...
        public void addSize(MessageSizeAccumulator _size, ObjectSerializationCache _cache, short _version) {
            ...
            _size.addBytes(8);
            {
                _size.addZeroCopyBytes(bytes.remaining());
                _size.addBytes(ByteUtils.sizeOfUnsignedVarint(bytes.remaining() + 1));
            }
            if (_unknownTaggedFields != null) {
                _numTaggedFields += _unknownTaggedFields.size();
                for (RawTaggedField _field : _unknownTaggedFields) {
        ...
        public PartitionSnapshot duplicate() {
            ...
            _duplicate.bytes = bytes.duplicate();
            return _duplicate;
        }
        ...
        public PartitionSnapshot setBytes(ByteBuffer v) {
            this.bytes = v;
            return this;
        }
    }
    ...
    public static class SnapshotId implements Message {
        ...
        public SnapshotId(Struct _struct, short _version) {
            fromStruct(_struct, _version);
        }
