...
public class ApiVersionsResponseDataJsonConverter {
    ...
    public static JsonNode write(ApiVersionsResponseData _object, short _version, boolean _serializeRecords) {
        ...
        for (ApiVersionsResponseKey _element : _object.apiKeys) {
            _apiKeysArray.add(ApiVersionsResponseKeyJsonConverter.write(_element, _version, _serializeRecords));
        }
    ...
    public static class ApiVersionsResponseKeyJsonConverter {
        ...
        public static JsonNode write(ApiVersionsResponseKey _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
