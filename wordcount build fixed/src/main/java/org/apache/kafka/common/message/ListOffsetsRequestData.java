...
public class ListOffsetsRequestData implements ApiMessage {
    ...
    public ListOffsetsRequestData(Struct _struct, short _version) {
    ...
    public void fromStruct(Struct struct, short _version) {
        ...
        }
        {
            ...
            this.topics = new ArrayList<ListOffsetsTopic>(_nestedObjects.length);
            for (Object nestedObject : _nestedObjects) {
                this.topics.add(new ListOffsetsTopic((Struct) nestedObject, _version));
            }
        }
        if (_version >= 6) {
    ...
    public Struct toStruct(short _version) {
        ...
        }
        {
            ...
            int i = 0;
            for (ListOffsetsTopic element : this.topics) {
    ...
    public static class ListOffsetsTopic implements Message {
        ...
        public ListOffsetsTopic(Struct _struct, short _version) {
            fromStruct(_struct, _version);
        }
        ...
        public void fromStruct(Struct struct, short _version) {
            ...
            this.name = struct.getString("name");
            {
                ...
                this.partitions = new ArrayList<ListOffsetsPartition>(_nestedObjects.length);
                for (Object nestedObject : _nestedObjects) {
                    this.partitions.add(new ListOffsetsPartition((Struct) nestedObject, _version));
                }
            }
            if (_version >= 6) {
                if (!_taggedFields.isEmpty()) {
        ...
        public Struct toStruct(short _version) {
            if (_version > 6) {
                throw new UnsupportedVersionException("Can't write version " + _version + " of ListOffsetsTopic");
            }
            TreeMap<Integer, Object> _taggedFields = null;
            if (_version >= 6) {
                _taggedFields = new TreeMap<>();
            ...
            struct.set("name", this.name);
            {
                ...
                int i = 0;
                for (ListOffsetsPartition element : this.partitions) {
                    _nestedObjects[i++] = element.toStruct(_version);
                }
    ...
    public static class ListOffsetsPartition implements Message {
        ...
        public ListOffsetsPartition(Struct _struct, short _version) {
            fromStruct(_struct, _version);
        }
        ...
        public Struct toStruct(short _version) {
            if (_version > 6) {
                throw new UnsupportedVersionException("Can't write version " + _version + " of ListOffsetsPartition");
            }
            TreeMap<Integer, Object> _taggedFields = null;
            if (_version >= 6) {
                _taggedFields = new TreeMap<>();
