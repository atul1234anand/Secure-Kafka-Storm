...
public class LeaderChangeMessage implements ApiMessage {
    ...
    public void fromStruct(Struct struct, short _version) {
        ...
        {
            Object[] _nestedObjects = struct.getArray("granting_voters");
            this.grantingVoters = new ArrayList<Voter>(_nestedObjects.length);
            for (Object nestedObject : _nestedObjects) {
                this.grantingVoters.add(new Voter((Struct) nestedObject, _version));
            }
        }
    ...
    public Struct toStruct(short _version) {
        ...
        {
            Struct[] _nestedObjects = new Struct[grantingVoters.size()];
            int i = 0;
            for (Voter element : this.grantingVoters) {
                _nestedObjects[i++] = element.toStruct(_version);
            }
            struct.set("granting_voters", (Object[]) _nestedObjects);
        }
