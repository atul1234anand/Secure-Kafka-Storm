...
public class ProduceResponseData implements ApiMessage {
    ...
    public void fromStruct(Struct struct, short _version) {
        ...
        }
        {
            ...
            this.responses = new TopicProduceResponseCollection(_nestedObjects.length);
    ...
    public static class TopicProduceResponse implements Message, ImplicitLinkedHashMultiCollection.Element {
        ...
        public void fromStruct(Struct struct, short _version) {
            ...
            this.name = struct.getString("name");
            {
                ...
                this.partitionResponses = new ArrayList<PartitionProduceResponse>(_nestedObjects.length);
                for (Object nestedObject : _nestedObjects) {
                    this.partitionResponses.add(new PartitionProduceResponse((Struct) nestedObject, _version));
                }
            }
            if (_version >= 9) {
                if (!_taggedFields.isEmpty()) {
        ...
        public Struct toStruct(short _version) {
            ...
            struct.set("name", this.name);
            {
                ...
                int i = 0;
                for (PartitionProduceResponse element : this.partitionResponses) {
                    _nestedObjects[i++] = element.toStruct(_version);
                }
