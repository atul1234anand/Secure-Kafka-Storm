...
public class ProduceRequestData implements ApiMessage {
    ...
    public void fromStruct(Struct struct, short _version) {
        ...
        {
            Object[] _nestedObjects = struct.getArray("topic_data");
            this.topicData = new TopicProduceDataCollection(_nestedObjects.length);
            for (Object nestedObject : _nestedObjects) {
                this.topicData.add(new TopicProduceData((Struct) nestedObject, _version));
            }
        }
        if (_version >= 9) {
    ...
    public Struct toStruct(short _version) {
        ...
        {
            Struct[] _nestedObjects = new Struct[topicData.size()];
            int i = 0;
            for (TopicProduceData element : this.topicData) {
                _nestedObjects[i++] = element.toStruct(_version);
            }
            struct.set("topic_data", (Object[]) _nestedObjects);
        }
        if (_version >= 9) {
    ...
    public static class TopicProduceData implements Message, ImplicitLinkedHashMultiCollection.Element {
        ...
        public void fromStruct(Struct struct, short _version) {
            ...
            {
                Object[] _nestedObjects = struct.getArray("partition_data");
                this.partitionData = new ArrayList<PartitionProduceData>(_nestedObjects.length);
                for (Object nestedObject : _nestedObjects) {
                    this.partitionData.add(new PartitionProduceData((Struct) nestedObject, _version));
                }
            }
            if (_version >= 9) {
                if (!_taggedFields.isEmpty()) {
        ...
        public Struct toStruct(short _version) {
            ...
            {
                Struct[] _nestedObjects = new Struct[partitionData.size()];
                int i = 0;
                for (PartitionProduceData element : this.partitionData) {
                    _nestedObjects[i++] = element.toStruct(_version);
                }
                struct.set("partition_data", (Object[]) _nestedObjects);
            }
            if (_version >= 9) {
                struct.set("_tagged_fields", _taggedFields);
            }
    ...
    public static class PartitionProduceData implements Message {
        ...
        public void fromStruct(Struct struct, short _version) {
            ...
            this.records = struct.getRecords("records");
            if (_version >= 9) {
                if (!_taggedFields.isEmpty()) {
                    this._unknownTaggedFields = new ArrayList<>(_taggedFields.size());
                    for (Entry<Integer, Object> entry : _taggedFields.entrySet()) {
        ...
        public Struct toStruct(short _version) {
            ...
            struct.set("records", this.records);
            if (_version >= 9) {
                struct.set("_tagged_fields", _taggedFields);
            }
            return struct;
