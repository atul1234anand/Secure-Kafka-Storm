...
public class EnvelopeRequestData implements ApiMessage {
    ...
    public EnvelopeRequestData(Struct _struct, short _version) {
    ...
    public void fromStruct(Struct struct, short _version) {
        ...
        this.requestData = struct.getBytes("request_data");
        this.requestPrincipal = struct.getByteArray("request_principal");
        this.clientHostAddress = struct.getByteArray("client_host_address");
    ...
    public Struct toStruct(short _version) {
        ...
        struct.set("request_data", this.requestData);
        struct.setByteArray("request_principal", this.requestPrincipal);
        struct.setByteArray("client_host_address", this.clientHostAddress);
