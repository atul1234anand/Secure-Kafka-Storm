...
public class OffsetForLeaderEpochResponseData implements ApiMessage {
    ...
    public void fromStruct(Struct struct, short _version) {
        ...
        }
        {
            ...
            this.topics = new OffsetForLeaderTopicResultCollection(_nestedObjects.length);
    ...
    public static class OffsetForLeaderTopicResult implements Message, ImplicitLinkedHashMultiCollection.Element {
        ...
        public void fromStruct(Struct struct, short _version) {
            ...
            this.topic = struct.getString("topic");
            {
                ...
                this.partitions = new ArrayList<EpochEndOffset>(_nestedObjects.length);
                for (Object nestedObject : _nestedObjects) {
                    this.partitions.add(new EpochEndOffset((Struct) nestedObject, _version));
                }
            }
            if (_version >= 4) {
                if (!_taggedFields.isEmpty()) {
        ...
        public Struct toStruct(short _version) {
            ...
            struct.set("topic", this.topic);
            {
                ...
                int i = 0;
                for (EpochEndOffset element : this.partitions) {
                    _nestedObjects[i++] = element.toStruct(_version);
                }
