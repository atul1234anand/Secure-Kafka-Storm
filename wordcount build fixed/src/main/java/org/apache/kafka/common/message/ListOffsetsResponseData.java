...
public class ListOffsetsResponseData implements ApiMessage {
    ...
    public ListOffsetsResponseData(Struct _struct, short _version) {
    ...
    public void fromStruct(Struct struct, short _version) {
        ...
        }
        {
            ...
            this.topics = new ArrayList<ListOffsetsTopicResponse>(_nestedObjects.length);
            for (Object nestedObject : _nestedObjects) {
                this.topics.add(new ListOffsetsTopicResponse((Struct) nestedObject, _version));
            }
        }
        if (_version >= 6) {
    ...
    public Struct toStruct(short _version) {
        ...
        }
        {
            ...
            int i = 0;
            for (ListOffsetsTopicResponse element : this.topics) {
    ...
    public static class ListOffsetsTopicResponse implements Message {
        ...
        public ListOffsetsTopicResponse(Struct _struct, short _version) {
            fromStruct(_struct, _version);
        }
        ...
        public void fromStruct(Struct struct, short _version) {
            ...
            this.name = struct.getString("name");
            {
                ...
                this.partitions = new ArrayList<ListOffsetsPartitionResponse>(_nestedObjects.length);
                for (Object nestedObject : _nestedObjects) {
                    this.partitions.add(new ListOffsetsPartitionResponse((Struct) nestedObject, _version));
                }
            }
            if (_version >= 6) {
                if (!_taggedFields.isEmpty()) {
        ...
        public Struct toStruct(short _version) {
            if (_version > 6) {
                throw new UnsupportedVersionException("Can't write version " + _version + " of ListOffsetsTopicResponse");
            }
            TreeMap<Integer, Object> _taggedFields = null;
            if (_version >= 6) {
                _taggedFields = new TreeMap<>();
            ...
            struct.set("name", this.name);
            {
                ...
                int i = 0;
                for (ListOffsetsPartitionResponse element : this.partitions) {
                    _nestedObjects[i++] = element.toStruct(_version);
                }
    ...
    public static class ListOffsetsPartitionResponse implements Message {
        ...
        public ListOffsetsPartitionResponse(Struct _struct, short _version) {
            fromStruct(_struct, _version);
        }
        ...
        public Struct toStruct(short _version) {
            if (_version > 6) {
                throw new UnsupportedVersionException("Can't write version " + _version + " of ListOffsetsPartitionResponse");
            }
            TreeMap<Integer, Object> _taggedFields = null;
            if (_version >= 6) {
                _taggedFields = new TreeMap<>();
