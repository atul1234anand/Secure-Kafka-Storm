...
public class StopReplicaRequestDataJsonConverter {
    public static StopReplicaRequestData read(JsonNode _node, short _version) {
        ...
        if (_ungroupedPartitionsNode == null) {
            ...
            ArrayList<StopReplicaPartitionV0> _collection = new ArrayList<StopReplicaPartitionV0>();
        ...
        if (_topicsNode == null) {
            ...
            ArrayList<StopReplicaTopicV1> _collection = new ArrayList<StopReplicaTopicV1>();
        ...
        if (_topicStatesNode == null) {
            ...
            ArrayList<StopReplicaTopicState> _collection = new ArrayList<StopReplicaTopicState>();
    ...
    public static class StopReplicaTopicStateJsonConverter {
        public static StopReplicaTopicState read(JsonNode _node, short _version) {
            ...
            if (_partitionStatesNode == null) {
                ...
                ArrayList<StopReplicaPartitionState> _collection = new ArrayList<StopReplicaPartitionState>();
